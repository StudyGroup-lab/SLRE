...
public class Gradients {
	...
	public void calculateGradients() throws Exception {
		...
		for (int p = 0; p < iNumberOfFactors; p++) {
			...
			Real_MatrixRGradient.add(iRelation, p, (dPartial * dRealRel)/ dSize);
			...
			Imag_MatrixRGradient.add(iRelation, p, (dPartial * dImagRel)/ dSize);
			
//			Real_MatrixEGradient.add(iHead, p, (dPartial * dRealHead  ) / dSize);
//			Real_MatrixEGradient.add(iTail, p, (dPartial * dRealTail )/ dSize);
//			Real_MatrixRGradient.add(iRelation, p, (dPartial * dRealRel)/ dSize);
//			Imag_MatrixEGradient.add(iHead, p, (dPartial * dImagHead )/ dSize);
//			Imag_MatrixEGradient.add(iTail, p, (dPartial * dImagTail )/ dSize);
//			Imag_MatrixRGradient.add(iRelation, p, (dPartial * dImagRel)/ dSize);
		}
	}
}
