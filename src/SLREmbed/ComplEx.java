...
public class ComplEx {
	...
	public void initialization(
		...
		m_MatrixE_prefix = "model/MatrixE-k" + m_NumFactor
                ...
                + "-cons" + decimalFormat.format(m_Con)
				+ "-neg" + m_NumNegative
		...
		System.out.println("\nInitializing gradients or gradient squares of matrix E and matrix R");
...
//		HashMap<Integer, ArrayList<Triple>> lstRelNegTriples = new HashMap<Integer, ArrayList<Triple>>();
...
//				HashSet<Triple> relNegTripleSet = negTripGen.generateRelNegTriple(m_NumNegative);
...
//					lstRelNegTriples.get(iID).addAll(relNegTripleSet);
				}
			}
...
//			lstRelNegTriples = new HashMap<Integer, ArrayList<Triple>>();
